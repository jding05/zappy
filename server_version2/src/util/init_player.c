...
void		s_init_new_player(int fd)
{
	...
	g_players[fd].request_nb = 0;
	memset(g_players[fd].inventory, 0, sizeof(int) * 7);
	g_players[fd].inventory[1] = 20;
	g_players[fd].inventory[2] = 20;
	g_players[fd].inventory[3] = 20;
	g_players[fd].inventory[4] = 20;
	g_players[fd].inventory[5] = 20;
	g_players[fd].inventory[6] = 20;
